 ...
 * @property {function(string): boolean} isChatPane Whether a panel is a chat pane, shown with a bold tab title.
 * @property {function(string): ?('active'|'inactive')} chatBorderKindOf Which border (if any) a zone's tab strip and frame should show, based on its active tab.
